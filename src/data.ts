...
export const ENEMIES: Record<EnemyType, EnemyConfig> = {
  light: { name: "轻型步兵", color: "#f4db6c", hp: 70, armor: 0, speed: 1, towerDamage: 14, attackCooldown: 1.1, attackRange: 1, coreDamage: 1, gold: 8 },
  heavy: { name: "重装兵", color: "#d47070", hp: 220, armor: 8, speed: 0.75, towerDamage: 38, attackCooldown: 1.8, attackRange: 1, coreDamage: 1, gold: 16 },
  engineer: { name: "工程兵", color: "#ff9e6d", hp: 140, armor: 2, speed: 0.95, towerDamage: 52, attackCooldown: 1, attackRange: 1, coreDamage: 1, gold: 18, activeSaboteur: true },
  beast: { name: "狂暴兽", color: "#8ef7a1", hp: 150, armor: 1, speed: 1.25, towerDamage: 22, attackCooldown: 0.8, attackRange: 1, coreDamage: 1, gold: 14, frenzy: true },
  destroyer: { name: "远程破坏者", color: "#8fc2ff", hp: 130, armor: 1, speed: 0.9, towerDamage: 28, attackCooldown: 1.4, attackRange: 3.5, coreDamage: 2, gold: 20, rangedBreaker: true },
  boss: { name: "Boss", color: "#ff4e5f", hp: 1800, armor: 14, speed: 0.8, towerDamage: 65, attackCooldown: 1.5, attackRange: 1.2, coreDamage: 5, gold: 120, boss: true, activeSaboteur: true },
};
